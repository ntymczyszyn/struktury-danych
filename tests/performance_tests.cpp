...
//        AVL_test(number, resInReverseOrderAVL,resDelReverseOrderAVL, orderedData);
//        AVL_test(number, resInRandomOrderAVL, resDelRandomOrderAVL, orderedData);
        skipList_test(number, resInOrderedSL, resDelOrderedSL, orderedData);
        skipList_test(number, resInReverseOrderSL,resDelReverseOrderSL, orderedData);
        skipList_test(number, resInRandomOrderSL, resDelRandomOrderSL, orderedData);
    }
